...
int main()
{
    /*#Bài 5: XÂY DỰNG MENU CHƯƠNG TRÌNH cho các bài tập trên*/
    int choice;
    do
    {
        printf("\nWelcome to BuiPhucVinh_PS49752_Lab3.");
        printf("\nChon 1 de tinh hoc luc.");
        printf("\nChon 2 de giải phương trình bậc nhất.");
        printf("\nChon 3 de giải Phương trình bậc 2.");
        printf("\nChon 4 de tình tiền điện tiêu thụ.");
        printf("\nChon 0 de thoat.");
        printf("\nLua chon cua ban:");
        scanf("%d", &choice);
        switch (choice)
